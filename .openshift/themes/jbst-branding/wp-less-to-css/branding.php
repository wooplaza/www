...
function load_options() {
	...
	function save_options($attach_id=null) {
	
		if($attach_id) set_theme_mod('brandimageid',$attach_id);
...
public function add_menu() 
{
	 ...
	 add_theme_page('Branding', 'Branding', 'manage_options', 'wp-less-to-css', array(&$this, 'JBST_branding_settings_page'));
} // END public function add_menu() 

/** * Menu Callback */ 
public function JBST_branding_settings_page() 
{ 
